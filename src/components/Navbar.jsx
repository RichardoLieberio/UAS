    ...
    return(
        <nav className="bg-white border-gray-200 dark:bg-gray-900">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="p-0.5 flex items-center justify-center cursor-pointer hover:bg-slate-200">
                    <div className="relative scale-75">
                        ...
                        <span className="absolute -top-2 left-4 rounded-full bg-red-500 px-2 text-base text-red-50">4</span>
                    </div>
                </div>
            </div>
        </nav>
